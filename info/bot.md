...
**RAG (Flowise + Qdrant):** Flowise должен стабильно достигать Qdrant (одна Docker-сеть с контейнером Qdrant или корректный URL в ноде ретривера). При обрыве связи RAG часто «молча» даёт пустой контекст. **Веб-интерфейс Qdrant:** [https://qdrant.bot.jeeptour41.ru/](https://qdrant.bot.jeeptour41.ru/)
...
- логика диалога
- системный промпт
- RAG на базе markdown-файлов с векторной БД **Qdrant**
...
**Связанный поддомен:** `qdrant.bot.jeeptour41.ru` — UI Qdrant (векторная БД RAG): [https://qdrant.bot.jeeptour41.ru/](https://qdrant.bot.jeeptour41.ru/)
